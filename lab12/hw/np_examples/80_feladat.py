...
np_gk = np_heights[np_positions == "GK"]
# print(np_gk)
gk_med = np.median(np_gk)
print(f"Kapus medián: {gk_med}")
np_non_gk = np_heights[np_positions != "GK"]
non_gk_med = np.median(np_non_gk)
print(f"Nemkapus medián: {non_gk_med}")
